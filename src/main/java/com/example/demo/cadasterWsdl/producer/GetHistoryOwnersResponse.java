...
@XmlRootElement(name = "GetHistoryOwnersResponse")
public class GetHistoryOwnersResponse {

    protected long request;
    protected GetHistoryOwnersResponse.Response response;
     ...
     * @return
     *     possible object is
     *     {@link GetHistoryOwnersResponse.Response }
     *     
     */
    public GetHistoryOwnersResponse.Response getResponse() {
        return response;
    }
     ...
     *     
     */
    public void setResponse(GetHistoryOwnersResponse.Response value) {
        this.response = value;
    }
