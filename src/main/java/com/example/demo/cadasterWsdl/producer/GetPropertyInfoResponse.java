 ...
 *         &lt;choice&gt;
 *           &lt;element name="response" type="{http://producer.x-road.eu}PropertyInfo"/&gt;
...
@XmlRootElement(name = "GetPropertyInfoResponse")
public class GetPropertyInfoResponse {

    protected long request;
    protected PropertyInfo response;
     ...
     *     
     */
    public PropertyInfo getResponse() {
        return response;
    }
     ...
     *     
     */
    public void setResponse(PropertyInfo value) {
        this.response = value;
    }
